...
| --button-text-color | Font color of the button. | `var(--fgdm-color-primary)` |
...
| --input-font-color | Font color of the input. | `var(--fgdm-color-text)` |
| --input-font-size | Font size of input. | `var(--fgdm-font-size-main)` |
