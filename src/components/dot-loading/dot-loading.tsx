...
const classPrefix = `fgdm-dot-loading`

const colorRecord: Record<string, string> = {
  default: 'var(--fgdm-color-weak)',
  primary: 'var(--fgdm-color-primary)',
  white: 'var(--fgdm-color-white)',
}
...
export const DotLoading = memo<DotLoadingProps>(p => {
  ...
  return withNativeProps(
    ...
    <div
      ...
      className={classNames('fgdm-loading', classPrefix)}
    >
      <svg
        height='1em'
        viewBox='0 0 100 40'
