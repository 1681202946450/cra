...
| 属性 | 说明 | 默认值 | 全局变量 |
| --- | --- | --- | --- |
| --background-color | 背景颜色 | `var(--fgdm-color-background)` | `--fgdm-button-background-color` |
| --border-color | 边框颜色 | `var(--fgdm-color-border)` | `--fgdm-button-border-color` |
| --border-radius | 圆角大小 | `4px` | `--fgdm-button-border-radius` |
| --border-style | 边框样式 | `solid` | `--fgdm-button-border-style` |
| --border-width | 边框宽度 | `1px` | `--fgdm-button-border-width` |
| --text-color | 文字颜色 | `var(--fgdm-color-text)` | `--fgdm-button-text-color` |
